...
import br.com.caelum.estoque.soap.QuantidadeEmEstoquePeloCodigo;
import br.com.caelum.estoque.soap.QuantidadeEmEstoquePeloCodigoResponse;
...
public class Carrinho implements Serializable {
	...
	public void verificarDisponibilidadeDosItensComSoap() {
		...
		QuantidadeEmEstoquePeloCodigo parameter = new QuantidadeEmEstoquePeloCodigo();
		parameter.getCodigoItem().addAll(codigos);
		
		QuantidadeEmEstoquePeloCodigoResponse resposta = estoqueWs.quantidadeEmEstoquePeloCodigo(parameter, "TOKEN123");
...
//		
//		this.itensDeCompra.stream().filter(ItemCompra::isImpresso).forEach( itemCompra -> {
//			try {
