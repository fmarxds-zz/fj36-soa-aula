...
public class EstoqueService extends UnicastRemoteObject implements EstoqueRmi {
	...
	@Override
	public ItemEstoque getItemEstoque(String codigosProduto) throws RemoteException {
		System.out.println("Verificad o estoque do produto: " + codigosProduto);
		return repositorio.get(codigosProduto);		
	}
